...
import signin from "../assets/logos/signin.png";
const navigation = [
  { name: "Home", href: "/" },
        ...
        <div className="relative flex items-center justify-between h-16">
          ...
          <div className="flex items-center justify-center flex-1 sm:items-stretch sm:justify-start">
            <div className="flex items-center shrink-0">
              <img
                alt="Your Company"
                src="https://media.istockphoto.com/id/1130888829/vector/letter-f-logotype-icon-design-template-technology-abstract-vector-logotype.jpg?s=612x612&w=0&k=20&c=YOV3-TNGNKisxp5McqiH2Nmf0WKC_5fLiIfvb7QMSVA="
                className="w-auto h-8 rounded-full"
              />
            </div>
            <div className="hidden text-3xl sm:ml-6 sm:block">
                ...
                {navigation.map((item) => (
                  <a
                    ...
                    className={classNames(
                      ...
                      "rounded-xl px-6 py-2 text-sm lg:text-base font-medium"
                    )}
                  >
                    {item.name}
                  </a>
          ...
          {/* Sign in  */}
          <Menu as="div" className="relative ml-3 font-Fira">
            <div>
              <MenuButton className="relative flex text-sm bg-gray-800 rounded-full focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-gray-800">
                ...
                <img alt="" src={signin} className="rounded-full size-8" />
              </MenuButton>
            </div>
            <MenuItems
              transition
